            ...
            <div class="row">
                ...
                <div class="col-3 search-top">
                    ...
                    <form action="search.php" class="search-top-form" method="post">
                        ...
                        <input type="text" name="search" id="s" placeholder="鬼ごっこで探索...">
                    </form>
                </div>
            </div>
        </div>
    ...
    <div class="container logo-wrap">
        <div class="row pt-5">
            <div class="col-12 text-center">
                ...
                <h1 class="site-logo"><a href="index.php">NetFriend</a></h1>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarMenu">
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="index.php">ホームページ</a>
                    </li>
                    <?php show_cat(); ?>
                    <li class="nav-item">
                        <a class="nav-link" href="contact.php">連絡先</a>
                    </li>
                </ul>
