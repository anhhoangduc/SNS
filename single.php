        ...
        <div class="container">
            ...
            <div class="row blog-entries element-animate">
                ...
                <div class="col-md-12 col-lg-8 main-content">
                    ...
                    <div class="pt-5">
                        <p>カテゴリー: <a href="#"><?php echo $post_category; ?></a> Tags: <a
                    ...
                    <div class="comment-form-wrap pt-2">
                        <h3 class="mb-5" style="text-align: center">コメント</h3>
                        <form action="single.php?post=<?php echo $post_id; ?>" method="POST" class="p-5 bg-light">
                            ...
                            <div class="form-group">
                                <input type="submit" value="コメント" name="comment" class="btn btn-primary">
                            </div>
